class BubbleChart {
    ...
    drawBubbles() {
        ...
        for (let i = 0; i < this.data.length; i++) {
            ...
            let r = minRadius + (maxRadius - minRadius) * ((this.data[i][2] - minSv) / (maxSv - minSv))
            ...
            bubble.addEventListener('click', (e) => {
                console.log('this.data: ', this.data[i][0], this.data[i][1], this.data[i][2])
            ...
            bubble.addEventListener('mouseover', (e) =>{
                ...
                document.getElementById('sperantaDeViata').innerHTML = "Speranta de Viata: " + this.data[i][2];
                ...
                bubbleToolTip.style.left = `${left + (right - left) / 2 - bubbleToolTip.offsetWidth / 2}px`;
